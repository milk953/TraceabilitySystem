...
function fn_ScanSMTSerialPcsNG() {
  ...
  async function getData(type, params) {
    if (type == "getProductData") {
      ...
      let result = "";
      await axios("/api/Common/getcheckspecialbyserial", {
              ...
              if (_strSerial.length == hfSerialLength) {
                ...
                if (hfSerialFixFlag == "Y" && _strScanResultUpdate != "NG") {
                  ...
                  if (hfConfigCheck == "Y" && _strScanResultUpdate != "NG") {
                    ...
                    if (strConfigDigit != hfConfigCode) {
                      _strMessageUpdate =
                ...
                if (hfCheckStartSeq == "Y" && _strScanResultUpdate != "NG") {
                  ...
                  const length =
                    ...
                    1;
                  _strStartSeq = _strSerial.substring(start,parseInt(hfCheckStartSeqEnd));
                ...
                if (hfCheckWeekCode == "Y" && _strScanResultUpdate != "NG") {
                  ...
                  const length =
                    ...
                    1;
                  _strWeekCode = _strSerial.substring(start, parseInt(hfCheckWeekCodeEnd));
                ...
                if (!_bolError && hfCheckPrdSht == "Y") {
                  ...
                  if (_strShtNo != "" && hfCheckPrdAbbr != result) {
                    ...
                    _intCountNG = 1;
                    _bolError = true;
                  } else if (!hfLotAll.includes(strSheetLot)) {
                    _strMessageUpdate =
                ...
                if (!_bolError &&hfPlasmaCheck == "Y" &&_strRejectGroup != "MASTER") {
                  ...
                  const responseDBL = await getData("GetPlasmaTimeBySerialNo", {
                    strSerial: _strSerial,
                    strPacking: txtMasterCode,
                ...
                if (!_bolError && hfCheckSPIAOI == "Y") {
                  ...
                  if (_dtShtData != "") {
                    ...
                    if (_Result._strresult == "NG") {
                      ...
                      _strRemark = _Result._strmessage;
                      _strScanResultUpdate = "NG";
                ...
                if (hfChipIDCheck == "Y" && _bolError == false) {
                  ...
                  let result = await getData("GetCheckChipDuplicate", {
                    strPrdname: _strPrdName,
                    strSerial: _strSerial,
                  }); //api
                ...
                if (hfCheckFinInspect == "Y" && _bolError == false) {
                  let _strInspResult = await getData(
                    "/GetSerialFinInspectResult",
                    {
                      strSerialNo: _strSerial,
                      strProc: hfCheckFinInspectProc,
                      strPrdName: _strPrdName,
                    }
                  ); //api ใหม่
                ...
                if (
                  ...
                  let _intCheckPass;
                  let resultCheckpass = await getData(
                    "GetCheckSpecialBySerial",
                    { strSerialno: _strSerial }
                  ); //api ใหม่
