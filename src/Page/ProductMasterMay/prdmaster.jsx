...
import "../ProductMasterMay/Style.css";
// import "./master.css";
import Popup from "../Product Master/ProductPopup.jsx";
import { Breadcrumb } from "antd";
import Hearder from "../Header/Header.jsx";
import ImgNext from "../ProductMasterMay/next.png";
import ImgBack from "../ProductMasterMay/previous.png";
...
import { fn_ProductMaster } from "../Product Master/function_ProductMaster.jsx";
import * as XLSX from "xlsx";
import { Navigate } from "react-router-dom";

function ProductMaster() {
  const { menuName, menuUrl, handleClickPath } = fn_Homepage();
  //   console.log(menuName, " ", menuUrl, "mayyyyy");
  const [Page, setPage] = useState("1");
  const [VisPage1, setVisPage1] = useState("");
  const [VisPage2, setVisPage2] = useState("none");
  const [VisPage3, setVisPage3] = useState("none");
  const [VisPage4, setVisPage4] = useState("none");
  const [VisPage5, setVisPage5] = useState("none");
  const [VisPage6 ,setVisPage6] = useState("none");
  ...
  const {
    ...
    txtBarcodeGrade,
    ReqCheckPrdShtCheck,
    ReqCheckPrdShtCheckChanged,
    ReqConShtPcsRollCheck,
    setReqConShtPcsRollCheck,
    ReqProcControlTimeCheck,
    ReqProcControlTimeCheckChanged,
    ReqConnShtPcsTimeCheck,
    setReqConnShtPcsTimeCheck,
    ReqFinalPackingGroupCheck,
    setReqFinalPackingGroupCheck,
    ReqShtControlPlasmaCheck,
    ReqShtControlPlasmaCheckChanged,
    PlasmaConnShtPcsCheck,
    setPlasmaConnShtPcsCheck,
    ConnShtReqBoardFlg,
    setConnShtReqBoardFlg,
    AutoPressFCheck,
    setAutoPressFCheck,
    AutoPressBCheck,
    setAutoPressBCheck,
    txtCheckPrdShtDisabled,
    txtStartSeqDigitFromDisabled,
    txtCheckPrdShtToDisabled,
    txtProcControlTimeDisabled,
    cbxReqConnShtPcsTimeDisabled,
    txtPlasmaTimeDisabled,
    rbtPlasmaTimePCSDisabled,
    rbtPlasmaTimeSHTDisabled,
    rbtPlasmaTimeGRPDisabled,
    cbxReqUpdatePlasmaDisabled,
    cbxPlasmaNotStartELTDisabled,
    cbxPlasmaNotShowTimeDisabled,
    visiblePassWord,
    visibletxtPassWord,
    txtProduct,
    handleKeyProductName,
    btnRetriveClick,
    ErrorPrdName,
    txtUpdateCount,
    txtChkStartDig,
    ...
    txtCheckLotShtTo,
    selStatus,
    ReqControlPlasmaCheck,
    rbtPlasmaTime,
    ReqUpdatePlasmaCheck,
    PlasmaNotStartELTCheck,
    PlasmaNotShowTimeCheck,
    ReqStartSeqCodeCheck,
    ReqCheckWeekCodeCheck,
    ReqSheetMCCheck,
    txtWeekCodeStart,
    txtStartSeqCode,
    txtStartSeqDigitFrom,
    txtStartSeqDigitTo,
    ReqShtELTCheck,
    ReqSPIAOICheck,
    ReqVendorLotCheck,
    ...
    txtDateFromProc,
    txtCheckRollPrdWord,
    RollReqCheckPrdLeafCheck,
    txtRollCheckPrdLeafFrom,
    txtWeekCodeEnd,
    ReqConRollLeafCheck,
    txtLeafScan,
    txtRollNoLength,
    txtLeafNoLength,
    LeafReqSerialCheck,
    ReqCheckPrdRollCheck,
    txtCheckRollPrdFrom,
    txtCheckRollPrdTo,
    ReqSPIBCheck,
    ReqAOICoatFCheck,
    ReqAOICoatBCheck,
    txtRollCheckPrdLeafTo,
    RollReqCheckLotLeafCheck,
    txtRollCheckLotLeafFrom,
    txtRollCheckLotLeafTo,
    ReqPreAOIFCheck,
    ReqPreAOIBCheck,
    ReqAOIFCheck,
    ReqAOIBCheck,
    ...
    ReqEFPCAOICheck,
    ReqEFPCOSTCheck,
    cbxReqCheckPrdShtDisabled,
    txtStartSeqCodeDisabled,
    txtStartSeqDigitToDisabled,
    txtVendorLotLengthDisabled,
    txtRollNoLengthDisabled,
    txtLeafNoLengthDisabled,
    txtLeafScanDisabled,
    cbxLeafReqSerialDisabled,
    cbxReqCheckPrdRollDisabled,
    txtCheckRollPrdFromDisabled,
    txtCheckRollPrdToDisabled,
    txtCheckRollPrdWordDisabled,
    cbxRollReqCheckPrdLeafDisabled,
    txtRollCheckPrdLeafFromDisabled,
    txtRollCheckPrdLeafToDisabled,
    cbxRollReqCheckLotLeafDisabled,
    txtRollCheckLotLeafFromDisabled,
    txtRollCheckLotLeafToDisabled,
    txtDateFromProcDisabled,
    cbxReqCheckWeekCodeDisabled,
    txtWeekCodeStartDisabled,
    txtWeekCodeEndDisabled,
    txtShtPlasmaTimeDisabled,
    txtFinInspectProcDisabled,
    cbxReqVendorDisabled,
    cbxReqStartSeqCodeDisabled,
    txtConfigWordDisabled,
    txtConfigStartDisabled,
    txtConfigEndDisabled,
    cbxReqConfigRunDisabled,
    txtCheckLotShtFromDisabled,
    txtCheckLotShtToDisabled,
    handleKeyUpdateCount,
    handleKeyCheckDigitFrom,
    handleKeyShtLot,
    handleKeyCheckDigitTo,
    handleKeyPcsSht,
    handleKeyCheckWord,
    handleselSheettype,
    handlerbtLotRollChange,
    setReqLotCheck,
    setReqVendorCheck,
    ReqConfigCheckChanged,
    setReqConfigRunCheck,
    ReqCheckLotShtCheckChanged,
    ReqControlPlasmaCheckChanged,
    handlerbtPlasmaTimeChange,
    setReqEFPCAVICheck,
    setReqSPIFCheck,
    setReqSPIBCheck,
    setReqAOICoatBCheck,
    setReqUpdatePlasmaCheck,
    setPlasmaNotStartELTCheck,
    setPlasmaNotShowTimeCheck,
    ReqStartSeqCodeCheckChanged,
    setReqShtELTCheck,
    setReqSPIAOICheck,
    ReqVendorLotCheckChanged,
    ReqDateProcCheckChanged,
    ReqCheckWeekCodeCheckChanged,
    setReqAOICoatFCheck,
    setReqSheetMCCheck,
    ReqConnectRollCheckChanged,
    setLeafReqSerialCheck,
    ReqCheckPrdRollCheckChanged,
    RollReqCheckPrdLeafCheckChanged,
    RollReqCheckLotLeafCheckChanged,
    setReqPreAOIFCheck,
    setReqPreAOIBCheck,
    setReqAOIFCheck,
    setReqAOIBCheck,
    ...
    setReqXrayFCheck,
    setReqXrayBCheck,
    setReqXrayOneTimeCheck,
    ReqFinInspectCheckChanged,
    setReqEFPCAOMCheck,
    setReqEFPCAOICheck,
    setReqEFPCOSTCheck,
    handlekeySerialLength,
    handlekeyPcsScan,
    handlekeyEngCode,
    handlekeyPcsTray,
    handlekeyRevision,
    handlekeySerialFormat,
    handleselLaminationSide,
    handlekeySheetFormat,
    handlekeyShtScan,
    handlekeyShtLaser,
    handlekeyConfigWord,
    handlekeyConfigStart,
    handlekeyConfigEnd,
    handlekeyDupStart,
    handlekeyDupEnd,
    handlekeyAddInfo,
    handlekeyPassWord,
    handlekeyAbbr,
    handlekeySerialStartCode,
    handlekeyCheckPrdShtFrom,
    handlekeyCheckPrdShtTo,
    handlekeyCheckLotShtFrom,
    handlekeyCheckLotShtTo,
    handleselStatus,
    handleselCheckIC,
    handlekeyPlasmaTime,
    handlekeyStartSeqCode,
    handlekeyStartSeqDigitFrom,
    handlekeyStartSeqDigitTo,
    handlekeyVendorLotLength,
    handlekeyDateFromProc,
    handlekeyWeekCodeStart,
    handlekeyWeekCodeEnd,
    handlekeyLeafScan,
    handlekeyRollNoLength,
    handlekeyLeafNoLength,
    handlekeyCheckRollPrdFrom,
    handlekeyCheckRollPrdTo,
    handlekeyCheckRollPrdWord,
    handlekeyRollCheckPrdLeafFrom,
    handlekeyRollCheckPrdLeafTo,
    handlekeyRollCheckLotLeafFrom,
    handlekeyRollCheckLotLeafTo,
    handlekeyProcControlTime,
    handlekeyFinInspectProc,
    handlekeyShtPlasmaTime,
    handlekeyBarcodeGrade,
    handlekeyUpdateBy,
    handlekeyUpdateDate,
    chk_DelFlgCheckChanged,
    btnSubmitClick,
    ErrorPrdNameMessage,
    lblMessage,
    lblMessageColor,
    ...
    ErrorStartSeqDigitFrom,
    ErrorStartSeqDigitFromMessage,
    ErrorStartSeqDigitTo,
    ErrorStartSeqDigitToMessage,
    ErrorVendorLotLength,
  ...
  const checkboxes = [chk_DelFlgCheck /* , ... */];
  const calculateProgress = () => {
    // จำนวนฟิลด์ทั้งหมด
    const totalFields = textFields.length + checkboxes.length;

    // จำนวนฟิลด์ที่มีค่า
    let filledFields = 0;

    // ตรวจสอบฟิลด์ข้อความ
    filledFields += textFields.filter((field) => field.trim() !== "").length;

    // ตรวจสอบเช็คบ็อกซ์
    filledFields += checkboxes.filter((checked) => checked).length;
  ...
  sx={{
    ...
    marginLeft: "4%",
    position: "fixed",
    top: 75, // หรือปรับตำแหน่งตามที่ต้องการ
    left: 0,
    padding: "16px",
    zIndex: 1000, // ทำให้แน่ใจว่า Box อยู่ด้านบนสุด
    width: "calc(100% - 8%)", // ปรับขนาดให้พอดีกับ marginLeft
    display: "flex", // จัดการให้ลูกอยู่ในบรรทัดเดียวกัน
    alignItems: "center", // จัดกึ่งกลางในแนวตั้ง
    justifyContent: "space-between", // ช่องว่างระหว่าง Breadcrumb และ Progress
  }}
>
  <Breadcrumb>
    <Breadcrumb.Item>TRACEABILITY SYSTEM</Breadcrumb.Item>
    <Breadcrumb.Item onClick={() => handleClickPath("HOME")}>
      <span style={{ cursor: "pointer" }}>Home</span>
    </Breadcrumb.Item>
    <Breadcrumb.Item onClick={() => handleClickPath(menuUrl)}>
      <span
        style={{
  ...
  style={{
    ...
    width: "95%",
    maxWidth: "1400px",
    marginTop: "70px", // เพิ่มระยะห่างจาก Box เพื่อให้เนื้อหาใน Card ไม่ถูกบัง
    height: "460px",
    padding: "20px",
    ...
    overflow: "auto",
    position: "relative", // ทำให้ Card อยู่ในบริบทตำแหน่งของตัวมันเอง
    zIndex: 1, // กำหนด zIndex ให้น้อยกว่า Box
  }}
>
  ...
  >
    ...
    >
      ...
      >
              ...
              <TableBody>
                <TableRow style={{   display:VisPage1}}>
                  <TableRow>
                    <TableCell>
                    ...
                    <TableCell style={{ width: "500px" }} colSpan={2}>
                      <Button
                        variant="contained"
                        size="small"
                ...
                <TableRow style={{ display:VisPage2 }}>
                <TableRow>
                    <TableCell style={{width:'250px'}}>
                    ...
                    <TableCell style={{width:'250px'}}>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtConfigWordDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtConfigStartDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtConfigEndDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtCheckPrdShtDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtCheckPrdShtToDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtCheckLotShtFromDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtCheckLotShtToDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtPlasmaTimeDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                ...
                <TableRow style={{  display:VisPage3}}>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setReqUpdatePlasmaCheck(e.target.checked)
                        }
                      />
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>
                      <Typography>
                        Not apply start PDS Time from ELT :
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setPlasmaNotStartELTCheck(e.target.checked)
                        }
                      />
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setPlasmaNotShowTimeCheck(e.target.checked)
                        }
                      />
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtStartSeqCodeDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtStartSeqDigitFromDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtStartSeqDigitToDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Typography>
                        Final Gate Req. SPI,Reflow,AOI,XRay :
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Checkbox
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtVendorLotLengthDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtDateFromProcDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqSPIFCheck(e.target.checked)
                              }
                            />
                          }
                          label="F Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqSPIBCheck(e.target.checked)
                              }
                            />
                          }
                          label="B Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqAOICoatFCheck(e.target.checked)
                              }
                            />
                          }
                          label="F Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqAOICoatBCheck(e.target.checked)
                              }
                            />
                          }
                          label="B Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqReflowFCheck(e.target.checked)
                              }
                            />
                          }
                          label="F Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqReflowBCheck(e.target.checked)
                              }
                            />
                          }
                          label="B Side"
                  ...
                  <TableRow>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqXrayFCheck(e.target.checked)
                              }
                            />
                          }
                          label="F Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqXrayBCheck(e.target.checked)
                              }
                            />
                          }
                          label="B Side"
                    ...
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setReqXrayOneTimeCheck(e.target.checked)
                        }
                      />
                    </TableCell>
                  </TableRow>
                </TableRow>
                <TableRow style={{ display:VisPage4}}>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtProcControlTimeDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    <TableCell>
                      <Typography>
                        Req. Include Connect Sht&Pcs Time :
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setReqConnShtPcsTimeCheck(e.target.checked)
                        }
                      />
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setReqFinalPackingGroupCheck(e.target.checked)
                        }
                      />
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtFinInspectProcDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtWeekCodeStartDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtWeekCodeEndDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtLeafScanDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtRollNoLengthDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtLeafNoLengthDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setLeafReqSerialCheck(e.target.checked)
                        }
                      />
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtCheckRollPrdFromDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtCheckRollPrdToDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtCheckRollPrdWordDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell style={{width:'250px'}}>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtRollCheckPrdLeafFromDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                    ...
                    <TableCell style={{width:'250px'}}>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtRollCheckPrdLeafToDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtRollCheckLotLeafFromDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                ...
                <TableRow style={{ display:VisPage5}}>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtRollCheckLotLeafToDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                    ...
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setReqConShtPcsRollCheck(e.target.checked)
                        }
                      />
                    </TableCell>
                  </TableRow>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqPreAOIFCheck(e.target.checked)
                              }
                            />
                          }
                          label="F Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqPreAOIBCheck(e.target.checked)
                              }
                            />
                          }
                          label="B Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqAOIFCheck(e.target.checked)
                              }
                            />
                          }
                          label="F Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setReqAOIBCheck(e.target.checked)
                              }
                            />
                          }
                          label="B Side"
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      <TextField
                        ...
                        style={{
                          backgroundColor: txtShtPlasmaTimeDisabled
                            ? "#EEEEEE"
                            : "inherit",
                        }}
                  ...
                  <TableRow>
                    <TableCell>
                      <Typography>
                        Combine Plasma Time&Connect Sht&Pcs :
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setPlasmaConnShtPcsCheck(e.target.checked)
                        }
                      />
                    </TableCell>
                    <TableCell>
                  ...
                  <TableRow>
                    <TableCell>
                      <Typography>
                        Final Gate Req. EFPC: AOM,AOI,OST,AVI :
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <FormGroup row>
                            ...
                            <FormControlLabel
                              control={
                                <Checkbox
                                  ...
                                  onChange={(e) =>
                                    setReqEFPCAOMCheck(e.target.checked)
                                  }
                                />
                              }
                              label="AOM-EFPC"
                            ...
                            <FormControlLabel
                              control={
                                <Checkbox
                                  ...
                                  onChange={(e) =>
                                    setReqEFPCAOICheck(e.target.checked)
                                  }
                                />
                              }
                              label="AOI-EFPC"
                            ...
                            <FormControlLabel
                              control={
                                <Checkbox
                                  ...
                                  onChange={(e) =>
                                    setReqEFPCOSTCheck(e.target.checked)
                                  }
                                />
                              }
                              label="OST-EFPC"
                            ...
                            <FormControlLabel
                              control={
                                <Checkbox
                                  ...
                                  onChange={(e) =>
                                    setReqEFPCAVICheck(e.target.checked)
                                  }
                                />
                              }
                              label="AVI-EFPC"
                  ...
                  <TableRow>
                    ...
                    <TableCell style={{width:'250px'}}>
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setConnShtReqBoardFlg(e.target.checked)
                        }
                      />
                    </TableCell>
                    <TableCell style={{width:'250px'}}>
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setAutoPressFCheck(e.target.checked)
                              }
                            />
                          }
                          label="F Side"
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={(e) =>
                                setAutoPressBCheck(e.target.checked)
                              }
                            />
                          }
                          label="B Side"
                ...
                {/* <TableRow style={{display:VisPage6}}>
</TableRow> */}
                {/* <TableRow style={{padding : 0}}>
                  <TableCell style={{padding:0,margin:0}} colSpan={3} align="center">
                  <Button  variant="contained"
                        size="small"
                        color="success"
                        sx={{ marginTop: "20px" }} onClick={BackPage}>Back</Button>  &nbsp;&nbsp;
                  <Button  variant="contained"
                        size="small"
                        color="success"
                        sx={{ marginTop: "20px" }} onClick={NextPage}>Next</Button>
                </TableCell>
                </TableRow> */}
              </TableBody>
            </Table>
