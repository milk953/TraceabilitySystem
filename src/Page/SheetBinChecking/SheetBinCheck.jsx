            ...
            <TableHead>
              <TableRow>
                <TableCell style={{ color: "white" }} colSpan={3}>
                  {menuName ? menuName : "Sheet Bin Checking"}
                </TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              <TableRow>
                <TableCell sx={{ fontSize: "15px" }} id="lbltxt">
                  Sheet No. :
                </TableCell>
                <TableCell>
                  <TextField
              ...
              <TableRow>
                ...
                >
                  <label id="lblSheet">{lblSheet}</label>
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
          ...
          <div className="pnlResult1">
            <Table id="TableResult1" component={Card}>
              <TableRow sx={{ height: "34px" }}>
                <TableCell sx={lblResult.styled}>
                  <label id="lblResult">{lblResult.text}</label>
                </TableCell>
              </TableRow>
            </Table>
          </div>
